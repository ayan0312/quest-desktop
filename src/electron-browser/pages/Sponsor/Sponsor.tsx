...
export class CardVerticalExample extends React.Component<{}, {}> {
    public render(): JSX.Element {
        ...
        const backgroundImageCardSectionTokens: ICardSectionTokens = {
            padding: 12
        }
        const agendaCardSectionTokens: ICardSectionTokens = { childrenGap: 0 }
        const attendantsCardSectionTokens: ICardSectionTokens = {
            childrenGap: 6
        }
        ...
        return (
            <Stack horizontal tokens={sectionStackTokens}>
                ...
                >
                    ...
                    <Card.Item fill>
                        <Image
                            src="https://placehold.it/256x144"
                            width="100%"
                    ...
                    <Card.Section>
                        ...
                        <Text styles={descriptionTextStyles}>
                            Contoso Denver expansion design marketing hero
                            guidelines
                        </Text>
